...
static int dt_probe(struct platform_device *pdev) {
    ...
    /* Read a u32 property */
    ret = of_property_read_32(np, "reg", &value);
    if (ret == 0) {
